...
public class BookingController {
	...
	public String checkInProcess(Model data,@RequestParam("booking_id") long booking_id) {
...
//			s.eq
		...
		data.addAttribute("passenger", pass);
		data.addAttribute("seat", seat);
